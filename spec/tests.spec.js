...
describe("Category resources", () => {
    ...
    {
         //var data = {};
         Request.get("http://localhost:3002/api/categories", (error, response, body) => {
    ...
    {
        Request.post("http://localhost:3002/api/categories", {form:newEntity} , (error, response, body) => {
    ...
    {
        Request.put("http://localhost:3002/api/categories", {form: {nombre_categoria:"PruebaEditted", "root_id": 1}} ,(error, response, body) => {
            expect(response.statusCode).toBe(200);
            done();
        })
    ...
    {
        Request.delete("http://localhost:3002/api/categories/"+newEntityID , (error, response, body) => {
            expect(response.statusCode).toBe(200);
            done();
        })
    ...
    {
         //var data = {};
         Request.get("http://localhost:3002/api/products", (error, response, body) => {
             expect(response.statusCode).toBe(200);
    ...
    {
        Request.post("http://localhost:3002/api/products", {form:newEntity2} , (error, response, body) => {
    ...
    {
        Request.get("http://localhost:3002/api/products/"+newEntityID2, (error, response, body) => {
    ...
    {
        Request.put("http://localhost:3002/api/products/"+newEntityID2, {form: {descripcion: "NuevoProductoEditted", nombre:"NombreProducto", imagen:"Path", precio: 22.50}} ,(error, response, body) => {
            expect(response.statusCode).toBe(200);
            done();
        })
    ...
    {
        Request.delete("http://localhost:3002/api/products/"+newEntityID2 , (error, response, body) => {
            newEntityID2 = response.body.insertId;
            expect(response.statusCode).toBe(200);
            done();
        })
    ...
    {
         //var data = {};
         Request.get("http://localhost:3002/api/users", (error, response, body) => {
             expect(response.statusCode).toBe(200);
             done();
         })
    });
    ...
    {
        Request.get("http://localhost:3002/api/user/"+newEntityID3, (error, response, body) => {
    ...
    {
        Request.post("http://localhost:3002/api/newuser", {form:newEntity3} , (error, response, body) => {
